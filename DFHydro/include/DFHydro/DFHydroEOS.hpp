...
public:
  ...
  double get_eta_by_s(double T, double muB) const { return eta_by_s; }
  double get_zeta_by_s(double T, double muB) const { return zeta_by_s; }
  void set_eta_by_s(double etabys_in) { eta_by_s = etabys_in; }
  void set_zeta_by_s(double zetabys_in) { zeta_by_s = zetabys_in; }
};
