...
The \texttt{EOS} class encapsulates the equation of state. It provides methods to compute thermodynamic variables like pressure, speed of
sound, and temperature as functions of energy density $e$.
