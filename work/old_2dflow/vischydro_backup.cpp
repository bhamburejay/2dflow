...
//
// On construction, the initia    l energy and velocity are read from the HDF5 file,
...
PetscErrorCode EulerRHSFunction(TS ts, PetscReal t, Vec U, Vec G, void *ctx) {
  ...
  for (int i = ixs; i < ixs + ixm + 1; i++) {
    ...
    // extrapolate i-1 to i-1/2idealHydroCellIFunctionDerivative
    { 
